...
class Comment(db.Model):
    ...
    parent_id = db.Column(db.Integer, db.ForeignKey("comments.id", name="fk_comments_parent_id"), nullable=True)
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
...
class UserPreference(db.Model):
    ...
    preference_value = db.Column(db.String(50), nullable=False)
...
class Wishlist(db.Model):
    ...
    post = db.relationship("Post", back_populates="wishlists_entries")
